...
st.title('PREDIKSI QUALITY WINE')
...
wine_qty_clasifikasi = ''

#Button Prediksi

if st.button('Test Quality Wine'):
    wine_qty_prediction = wine_model.predict([[fixed_acidity, volatile_acidity, citric_acid, residual_sugar, chlorides, free_sulfur_dioxide, total_sulfur_dioxide, density, pH, sulphates, alcohol]])
    if (wine_qty_prediction[0] == 0):
        wine_qty_clasifikasi ='Kualitas Wine Baik'
    else :
         wine_qty_clasifikasi ='Kualitas Wine Baik'
st.success(wine_qty_clasifikasi)
